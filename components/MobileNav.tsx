      ...
      <nav className="absolute right-0 top-0 w-80 h-full bg-white shadow-2xl flex flex-col">
        ...
        <div className="px-4 pb-8 space-y-3">
          <Link
            href="/suivi"
            onClick={onClose}
            className="flex items-center justify-center gap-2 w-full px-5 py-3 border border-gray-200 text-[#1e3a5f] font-semibold rounded-xl transition-colors hover:bg-[#f5f6f8]"
          >
