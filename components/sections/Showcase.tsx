...
const items = [
  ...
  },
  {
    id: 'maison-3',
    label: 'Maison 3',
    beforeSrc: '/maison_3_before.jpeg',
    afterSrc: '/maison_3_after.jpeg',
    beforeAlt: 'Maison avant travaux',
    afterAlt: 'Maison après travaux',
  },
  {
    id: 'veranda-3',
    label: 'Véranda 3',
    beforeSrc: '/veranda3_before.jpeg',
    afterSrc: '/veranda3_after.jpeg',
    beforeAlt: 'Véranda avant travaux',
    afterAlt: 'Véranda après travaux',
  },
  {
    id: 'maison-4',
    label: 'Maison 4',
    beforeSrc: '/maison_4_before.jpeg',
    afterSrc: '/maison_4_after.jpeg',
    beforeAlt: 'Maison avant travaux',
    afterAlt: 'Maison après travaux',
  },
  {
    id: 'veranda-4',
    label: 'Véranda 4',
    beforeSrc: '/veranda4_before.jpeg',
    afterSrc: '/veranda4_after.jpeg',
    beforeAlt: 'Véranda avant travaux',
    afterAlt: 'Véranda après travaux',
  },
  {
    id: 'maison-5',
    label: 'Maison 5',
    beforeSrc: '/maison_5_before.jpeg',
    afterSrc: '/maison_5_after.jpeg',
    beforeAlt: 'Maison avant travaux',
    afterAlt: 'Maison après travaux',
  },
  {
    id: 'veranda-5',
    label: 'Véranda 5',
    beforeSrc: '/veranda5_before.jpeg',
    afterSrc: '/veranda5_after.jpeg',
    beforeAlt: 'Véranda avant travaux',
    afterAlt: 'Véranda après travaux',
  },
]
